...
def show_help_menu(call):
    text = f"Рады приветствовать вас в разделе «Помощь»! \nМы всегда готовы оказать поддержку и проконсультировать по любым вопросам,\nсвязанным с нашим сервисом. Не стесняйтесь обращаться в службу поддержки @{support}"
